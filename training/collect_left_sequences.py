...
CAMERA_INDEX = 0
FRAME_DELAY = 0.06
WINDOW_NAME = "Collect Left Hand Sequences"
...
def draw_info(frame, class_name, saved):
    ...
    cv2.putText(frame, "LEFT hand only", (10, 100),
...
def record_sequence(cap, class_name, seq_id):
    ...
    while len(sequence) < SEQ_LEN:
        ...
        left_features, _, _, _ = extract_left_and_right(results)

        sequence.append(left_features)
        ...
        cv2.putText(frame, "LEFT hand only", (10, 135),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255, 255, 255), 2)
...
def main():
    ...
    hands.close()
    print("[INFO] Left-hand collection done")
